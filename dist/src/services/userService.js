...
var UserAlreadyExist_1 = __importDefault(require("../errors/UserAlreadyExist"));
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.createUser = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userExist, hashed, user, newUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this._userRepository.findByEmail(email)];
                    case 1:
                        userExist = _b.sent();
                        if (userExist) {
                            throw new UserAlreadyExist_1.default();
                        }
                        return [4 /*yield*/, password_1.hashPassword(password)];
                    case 2:
                        hashed = _b.sent();
                        user = new users_1.User({ name: name, password: hashed, email: email });
